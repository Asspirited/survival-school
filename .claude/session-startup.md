...
```bash
cd /home/rodent/survival-school && cat .claude/session-startup.md .claude/shared-session-state.md .claude/project-brief.md docs/backlog.md docs/waste-log.md > /mnt/c/Users/roden/Downloads/session-ref.md && echo "session-ref.md ready"
```
