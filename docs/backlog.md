...
| 27 | SS-172 — Wall Walkers: quiz data layer — question bank (12 categories, 13 GPS stops, 80+ pre-loaded questions), flora/fauna collection DB with rarity tiers (bronze/silver/gold/legendary) | DONE (verified live 2026-04-23 — 148 questions + 101 species across 5 rarity tiers incl. new Mythic via cusslab commit 08c060d) | DDD | Epic: "Wall Walkers"
| 27 | SS-173 — Wall Walkers: worker route GET /survival-school/wall-walkers — mobile-first HTML, GPS trigger logic, quiz UI, two-player sync via shared game code, offline pre-loaded core | DONE (verified live 2026-04-23 — route returns 200 with QUESTIONS/SPECIES/LEGEND_TOPICS inlined "for offline" per comment line 14597) | BDD | Epic: "Wall Walkers"
| 27 | SS-174 — Wall Walkers: homepage tile (top position) + left-nav banner — Ivan must find it instantly on his phone | DONE (verified live 2026-04-23 — tile at SURVIVAL_SCHOOL_WALL_WALKERS linked from homepage at worker.js:3290) | BDD | Epic: "Wall Walkers"
| 18 | SS-175 — Wall Walkers: flora/fauna collection mechanic — spot and collect species, rarity tiers, SS characters comment on sightings (Bear misidentifies, Ray corrects) | DONE (cusslab commit 08c060d, deployed 2026-04-23 — 101 species across 5 rarity tiers, 16-bit SVG rarity badges + type icons, per-rarity points 5/15/50/200/1000, character quips incl. misquote of user note, MYTHIC tier fires full-panel auto-dispute ConspireEngine) | BDD | Epic: "Wall Walkers"
...
| 18 | SS-191 — Wall Walkers: Bede character doc — full character file with real Ecclesiastical History excerpts, known views on Wall locations, theological positions, personality from historical sources, comedy engine, myths about Bede. New character doc at docs/characters/venerable-bede.md | DONE (2026-04-23 — expanded docs/characters/venerable-bede.md from 95 lines to 290+: real HE excerpts with book/chapter refs incl. Severus error + Picts-as-worms + Cuthbert's Carlisle fountain + Bede on tides vs Pliny; theological positions (Whitby, computus, Plegwine heresy accusation); Wall-location views incl. Jarrow/Lindisfarne/Hexham/Bamburgh/Tynemouth; Bede's letters (Egbert, Acca, Plegwine); myths incl. angel-VENERABILIS, stolen bones, Death Song 35-manuscripts, tomb slab; anchorman responsibilities; integration with cusslab BEDE_WALL_WALKERS_BANK) | DDD | Epic: "Wall Walkers"
...
| 14 | SS-199 — Wall Walkers: collectibles deep dive — explore collection mechanic beyond photo proof. Categories, achievements, rare sighting bonuses, daily collection challenges, expert commentary on evidence quality, end-of-day collectibles review with panel roasting. | DONE first-pass (cusslab commit 08c060d, deployed 2026-04-23 — points-per-rarity scoring, mythic tier with ConspireEngine dispute, expanded panel commentary on every sighting incl. note-based misquotes from Theroux/Boycott/Mitchell/Clarkson. Remaining for future: achievements, daily challenges, end-of-day roast pass) | BDD | Epic: "Wall Walkers"
...
| 8 | SS-206 — Wall Walkers: notes alongside photos in Collection. When capturing a species sighting, user can attach a free-text note stored with the photo + GPS + timestamp. | DONE (cusslab commit 08c060d, deployed 2026-04-23 — textarea in photo-capture modal with "panel may quote you later" placeholder, saved to state.sightings[id].note, preview rendered on species card, edit button in review mode. Also: panel sighting quips now include misquote-of-user-note variants for Theroux/Boycott/Mitchell/Clarkson when a note exists) | BDD | Epic: "Wall Walkers"
...
| 24 | SS-211 — Fish-Out-of-Water Pack Two: wire David Mitchell, Louis Theroux, Jeremy Clarkson, Geoffrey Boycott (Cusslab crossover) into js/characters.js. Character docs complete (2026-04-22). Needs: CHARACTERS entries, CHAR_COLOURS, FISH_DISPOSITIONS, escalation profiles, pack definition in CHARACTER_PACKS, pattern-affinity wiring. | DONE (cusslab commit 5c772ff, deployed 2026-04-23 — 4 flavour banks + build functions added to cusslab/worker.js, wired into all 5 Wall Walkers endpoints with GUEST PANEL instructions. Live verification: Boycott 9 mechanics firing on queue-etiquette topic incl. "Back in the hutch before lunch" + "My mother... would've sorted it" + not-on-my-watch. Mitchell reasoned-collapse pure form. Theroux repeat-back-as-question + let-them-hang. Clarkson CAPS + Range-Rover-vs-Peugeot + Kaleb. Boycott's Napoleon-in-Russia turn hit the 2026-04-22 Rod calibration point on landing: "Rubbish general, that one. Played across the line from start to finish..." NOTE: SS-side characters.js integration still open — these banks live in cusslab/worker.js only, parallel to the SS roster. Worth raising follow-up item to align the two systems under SS-219) | DDD | Epic: "Fish-out-of-water"
...
| 24 | SS-222 — Archetype #014 candidate: Bureaucratic Procedure Applied to Impossible Thing (Python signature). Rod 2026-04-23: "definitely use their Bureaucracy contrast and ridiculous-ness — could work really really well with both Bede, Hadrian, history." Priority mechanic for Wall Walkers Legends / Wilderment / Bede-anchor scenes. Parameterisations: Bede (scholarly-monastic bureaucracy — citation, qualification, source-attribution applied to a werewolf claim), Hadrian/Roman history (expense reports for wall construction, supply-chit for a cohort recon), Medieval/monastic (Benedictine Rule procedure). Slot banks: FORMAL_PROCEDURE (requisition orders, form-filling, chain-of-approval, citation style, risk assessments, permits, environmental impact reports), IMPOSSIBLE_TARGET (werewolf, ghost, dragon, mythological event, impossibility claim from panel, Roman imperial project). Rod canonical line 2026-04-23: "Health & Safety have shut down the Wall project" — applies modern British bureaucracy to 2nd-century Roman imperial engineering. Variants: "the risk assessment came back red, Hadrian", "three more forms before centurion deployment", "the impact survey on the turf vs stone section is due next Tuesday", "Marcus Cocceius Firmus missed the asbestos briefing". Fits Bede primarily; Fox (tactical-operational paperwork), McNab/Ryan if in scene (op-report register), Mitchell (pedantic form-filling adjacent); does NOT fit Bear (too impatient), Irwin (too enthusiastic), Clarkson (anti-bureaucratic by temperament — but could fire the TARGET role as the impossible-thing-being-processed). Feeds into SS-221 research pass as a standalone archetype ready to build. | Open | BDD | Epic: "Voice rebuild"
| 21 | SS-221 — Comedy technique research pass. Research Monty Python + Bill Hicks + Frankie Boyle + Ricky Gervais + Dave Chappelle + Richard Pryor + Louis CK + Ron Atkinson (Cusslab) + Terry Pratchett (Cusslab). Extract technique signatures per comedian/troupe. Map to existing Pattern Lab archetypes. Identify gaps — three classes emerging: (1) INCONGRUITY family (Python's Non-sequitur, Escalation-Through-Pedantic-Contradiction, Literal-Minded-Interpretation, Bureaucratic-Procedure-on-Impossible-Thing, Cross-Cutting-Interruption, Authority-Figure-Fall); (2) RECOGNITION family — NEW class revealed by Bill Hicks, comedy of reality-excavation where the laugh is recognition not surprise ("Go back to bed America"); (3) CHARACTER-RESTRAINT family (Gervais's silence-as-weapon, Chappelle's callback-structure + audience-acknowledgement, Pratchett's footnoted-asides, Boyle's taboo-approach-with-moral-core). Raise new Archetypes #012+ per technique. Each archetype gets the same 4-tier treatment + character parameterisations across both Cusslab and SS rosters. Rod 2026-04-23: "Monty Python masters of the non-sequitur" + "Bill Hicks techniques of being able to make you realise how crazy the world actually is — based on reality being crazier than imagination" + "we can do it with other great comedians I love (mostly in heckler)". | Open | DDD | Epic: "Voice rebuild"
| 27 | SS-220 — Character schema conformance pass. Canonical 17-attribute character schema (from cusslab/characters-schema.md) promoted to leanspirited-standards/standards/character-schema.md on 2026-04-23. Every character must implement all 17 attributes: P1 Wound, P2 Mask vs Truth, P3 Status Register, P4 Escalation Shape, P5 Comic Mechanism, P6 Relational Hunger, P7 Register Ceiling, P8 Relationship to Truth (psychological layer), M1-M9 mechanical connections (Wolf Pack Stance, Interruption Character, Debt Ledger, Speech Mode Unlock Routes, Round Decay Rate, Pool Rotation Logic, Pre-Existing Relationships, Your-State Voice, + one more). **Priority targets (surfaced by Rod 2026-04-23 live testing):** 4 Pack Two characters (Mitchell, Theroux, Clarkson, Boycott) + Wall Walkers Irwin (currently "CRIKEY impression"), Fox (needs edge), Attenborough (too bland — needs Cox-tier condescending exaggeration). Secondary: the other 5 Wall Walkers regulars + eventually 33-character SS roster. Parallel upgrade: cusslab/worker.js BANK constants must mirror the schema (add wound/mask/tracked_state/escalation/relational to each bank, not just mannerisms+flavours). | Open | DDD | Epic: "Voice rebuild"
